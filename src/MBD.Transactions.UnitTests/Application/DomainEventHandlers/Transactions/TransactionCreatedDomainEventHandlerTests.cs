...
namespace MBD.Transactions.UnitTests.Application.DomainEventHandlers.Transactions
{
    public class TransactionCreatedDomainEventHandlerTests
    {
        ...
        public TransactionCreatedDomainEventHandlerTests()
        {
        ...
        public async Task Handle_ReturnSuccess()
        {
            ...
            var @event = new TransactionCreatedDomainEvent(transaction);
            var handler = _autoMocker.CreateInstance<TransactionCreatedDomainEventHandler>();
            ...
            .Verify(x => x.CreateEventAsync<TransactionCreatedIntegrationEvent>(It.Is<TransactionCreatedIntegrationEvent>(x => x.Id == @event.AggregateId
                                                                                                                               ...
                                                                                                                               && x.TimeStamp == @event.TimeStamp), "transaction.created"), Times.Once);
        }
    }
}